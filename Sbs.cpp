...
void admin_menu()
{
	...
	{
		clrscr();
		cout<<"\n\t WELCOME  TO  DUNDERMIFLIN STORE "<<name<<endl;
		getch();
	...
	switch(option)
	{
		...
		case 4: cout<<"Enter key of element to be deleted:";
			cin>>skey;
			s.remove(skey);
			cout<<"item having respective key is deleted";
			break;
		case 5: cout<<"Enter key of element to be modified:\n";
			cin>>skey;
			s.remove(skey);
			cout<<endl<<"\nenter modified item\n " <<endl;
			     t= s.read();
				...
				indsize++;
				ind1.readi();
				cout<<"item having respective key is modified";
			    }
...
void main()
{
	clrscr();
	cout<<"\n\n\n\n \t\t\t ********** "<<endl  ;
	cout<<" \t\t\t WELCOME TO DUNDERMIFLIN STORE "<<endl  ;
	cout<<" \t\t\t ********** "<<endl  ;
	cout<<"\n\n\t\t\t\t\t\t\t PROJECT BY:\n\t\t\t\t\t\t\t -> PRANEETH \n\t\t\t\t\t\t\t -> VIKAS \n\t\t\t\t\t\t\t -> SYED \n\t\t\t\t\t\t\t";
	cout<<"\n\n\n";
	cout<<"\t *******\n";
